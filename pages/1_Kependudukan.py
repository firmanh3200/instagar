...
st.title(':orange[STATISTIK] :blue[KEPENDUDUKAN] :green[KABUPATEN GARUT]')
...
with st.container(border=True):
    # URL API Open Data
    url = "https://data.jabarprov.go.id/api-backend//bigdata/disdukcapil_2/od_17892_jml_penduduk__jk_kabupatenkota?limit=100&skip=0&where=%7B%22kode_kabupaten_kota%22%3A%5B%223205%22%5D%7D"
    ...
    st.subheader('Perkembangan Jumlah Penduduk Kabupaten Garut')
    ...
    # KELOMPOK UMUR
    with tab3:
        url3 = 'https://data.jabarprov.go.id/api-backend//bigdata/disdukcapil_2/od_18305_jml_penduduk__kelompok_umur_kabupatenkota?limit=1000&skip=0&where=%7B%22kode_kabupaten_kota%22%3A%5B%223205%22%5D%7D'
        ...
        if pilihan:
            st.subheader(f'Penduduk Kabupaten Garut menurut Kelompok Umur Tahun {pilihan}')
    ...
    # STATUS KAWIN    
    with tab4:
        st.subheader('Penduduk Kabupaten Garut menurut Status Kawin')
        url4 = 'https://data.jabarprov.go.id/api-backend//bigdata/disdukcapil_2/od_15135_jumlah_penduduk_berdasarkan_status_perkawinan_v1?limit=3000&skip=0&where=%7B%22kode_kabupaten_kota%22%3A%5B%223205%22%5D%7D'
...
st.subheader('', divider='rainbow')
st.caption(':orange[Instagar - Statistik Daerah Kabupaten Garut]')
st.caption('Hak Cipta @ :green[BPS Kabupaten Garut]')