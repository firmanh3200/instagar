...
st.title('Kemiskinan Makro Kabupaten Garut')
...
with kol1a:
    with st.container(border=True):
        st.success('Perkembangan Jumlah Penduduk Miskin di Kabupaten Garut')
...
with kol1b:
    with st.container(border=True):
        st.info('Garis Kemiskinan Kabupaten Garut')
...
with st.expander('Lihat Tabel Lengkap'):
    st.success('Indikator Kemiskinan Makro Kabupaten Garut')
