...
st.title('Statistik Ketenagakerjaan Kabupaten Garut')
...
with kol1a:
    with st.container(border=True):
        st.success('Tren Tingkat Pengangguran Terbuka (TPT) Kabupaten Garut dan Jawa Barat')
...
with kol1b:
    with st.container(border=True):
        st.info('Tren Tingkat Partisipasi Angka Kerja (TPAK) Kabupaten Garut dan Jawa Barat')
...
with st.expander('Lihat Tabel Lengkap'):
    st.warning('Indikator Ketenagakerjaan Makro Kabupaten Garut dan Jawa Barat')
