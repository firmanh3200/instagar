...
st.title('Indikator Pembangunan Manusia Kabupaten Garut')
...
with st.container(border=True):
    st.success('Tren IPM Kabupaten Garut')
...
with kol1a:
    with st.container(border=True):
        st.info('Tren Pengeluaran Perkapita Disesuaikan (000 Rp) Kabupaten Garut')
...
with kol1b:
    with st.container(border=True):
        st.warning('Pertumbuhan IPM Kabupaten Garut (%)')
...
with kol2a:
    with st.container(border=True):
        st.warning('Tren Lama Sekolah di Kabupaten Garut')
...
with kol2b:
    with st.container(border=True):
        st.info('Tren Usia Harapan Hidup (UHH) di Kabupaten Garut')
...
with st.expander('Lihat Tabel Lengkap'):
    st.success('Indikator Pembangunan Manusia Kabupaten Garut')
