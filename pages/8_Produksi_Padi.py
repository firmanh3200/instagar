...
st.title('Produksi Padi dan Beras di Kabupaten Garut')
...
with kol1a:
    with st.container(border=True):
        st.success('Luas Panen Padi di Kabupaten Garut (Hektare)')
...
with kol1b:
    with st.container(border=True):
        st.info('Produksi Padi di Kabupaten Garut (Ton GKG)')
...
with st.expander('Produksi Beras'):        
    with st.container(border=True):
        st.success('Produksi Beras di Kabupaten Garut (Ton)')
...
with st.expander('Lihat Tabel Lengkap'):
    st.warning('Hasil Survei KSA di Kabupaten Garut')
